...
<div class="sentinel-captcha" data-sitekey="{{ $sentinelSiteKey }}"@if(!empty($widget)) data-widget="{{ $widget }}"@endif @if(!empty($theme)) data-theme="{{ $theme }}"@endif @if(!empty($scheme)) data-scheme="{{ $scheme }}"@endif @if(!empty($difficulty)) data-difficulty="{{ $difficulty }}"@endif></div>
